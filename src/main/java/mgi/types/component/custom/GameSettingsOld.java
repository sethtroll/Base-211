...
public class GameSettingsOld extends ComponentDefinitions {
    public ArrayList<ComponentDefinitions> assemble(final int interfaceId) {
        ...
        final String[] settings = new String[]{"Level-up dialogues", "Rare drop broadcasts", "Level-99 broadcasts", "Maxed player broadcasts", "200 million XP broadcasts", "Pet broadcasts", "Hardcore Ironman death broadcasts"};
