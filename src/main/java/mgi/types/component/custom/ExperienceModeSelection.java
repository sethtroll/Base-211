...
public class ExperienceModeSelection extends ComponentDefinitions {
    public ArrayList<ComponentDefinitions> assemble() {
        ...
        add(componentId++, component);
        final String[] xpModes = new String[]{"50x Combat<br>25x Skilling", "10x Combat<br>10x Skilling", "5x Combat<br>5x Skilling"};
        final String[] ops = new String[]{"50x Combat & 25x Skilling", "10x Combat & 10x Skilling", "5x Combat & 5x Skilling"};
