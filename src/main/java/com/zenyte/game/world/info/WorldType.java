...
public enum WorldType {
    ...
    public static final Int2ObjectOpenHashMap<WorldType> WORLDS = new Int2ObjectOpenHashMap<>(VALUES.length);
    static int amount = 0;
    ...
    public static void updateWorldList() throws IOException {
