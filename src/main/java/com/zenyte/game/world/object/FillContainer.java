...
public class FillContainer extends Action {
    ...
    public enum FillCombinations {
        FILL_WATER("", Animation.GRAB, new Integer[][]{{229, 1923, 1925, 1935, 20800, 5331, 5333, 5334, 5335, 5336, 5337, 5338, 5339, 1831, 1829, 1827, 1825}, {227, 1921, 1929, 1937, 20801, 5340, 5340, 5340, 5340, 5340, 5340, 5340, 5340, 1823, 1823, 1823, 1823}}, "well", "fountain", "sink", "geyser", "water barrel", "waterpump", "pump and drain", "tap"),
        ...
        public static Map<String, FillCombinations> combos = new HashMap<>();
