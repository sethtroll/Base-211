...
public class DoubleDoor {
     ...
     */
    private static final Map<WorldObject, DoubleDoor> HANDLED_DOORS = new HashMap<>();
    ...
    private static void add(final int key, final int value) {
        map.put(key, value);
        map.put(value, key);
    }
    ...
    public static DoubleDoor handleGraphicalDoubleDoor(final Player player, final WorldObject object,
