...
public final class Gate {
     ...
     */
    private static final Map<WorldObject, Gate> HANDLED_GATES = new ConcurrentHashMap<>();
     ...
     */
    static int getRespectiveId(final int id) {
     ...
     */
    static WorldObject getOtherGate(final WorldObject gate) {
        WorldObject object;
     ...
     */
    static WorldObject getInnerMapGate(final WorldObject object, final WorldObject otherGate) {
     ...
     */
    public static void handleGate(final WorldObject object) {
