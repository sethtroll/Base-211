...
public enum CapesData {
    ...
    MAX(new Animation(7121), new Graphics(1286), new Item(13342), new Item(13280), new Item(13282), new Item(13329), new Item(13331), new Item(13333), new Item(13335), new Item(13337), new Item(13342), new Item(20760), new Item(21186), new Item(21284), new Item(21285), new Item(21776), new Item(21780), new Item(21784), new Item(21898));
    public static final CapesData[] VALUES = values();
    public static final Map<Integer, CapesData> MAP = new HashMap<>(VALUES.length);
