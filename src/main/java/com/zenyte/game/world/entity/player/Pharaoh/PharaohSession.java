 ...
 */
public class PharaohSession {
    private final Date login;
    private final Date logout;

    public PharaohSession(final Date login, final Date logout) {
        this.login = login;
        this.logout = logout;
    }
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        if (!(o instanceof PharaohSession other)) return false;
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return other instanceof PharaohSession;
    }
    ...
    public String toString() {
        return "PharaohSession(login=" + this.getLogin() + ", logout=" + this.getLogout() + ")";
    }
}
