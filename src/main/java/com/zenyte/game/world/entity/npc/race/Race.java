...
public enum Race {
    ...
    public static final Map<Integer, Race> MAP = new HashMap<>(250);
     ...
     */
    public static Race getRace(final int npcId) {
    ...
    public static Race getAnimationRace(final int animationId) {
