...
public abstract class RouteEvent<E extends Entity, S extends RouteStrategy> {
     ...
     *
     * @param entity   the entity who is executing the event.
     * @param strategy the strategy used to execute the event.
     * @param event    the runnable associated to the event, executed upon successfully reaching the destination.
     * @param delay    the delay in ticks until the event is executed after reaching the destination.
     */
