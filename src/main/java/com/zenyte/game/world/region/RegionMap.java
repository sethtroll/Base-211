...
public class RegionMap {
    ...
    public static boolean checkWalkStep(final int plane, final int x, final int y, final int xOffset, final int yOffset, final int size, final boolean checkCollidingNPCs, final boolean checkCollidingPlayers) {
        int collisionFlag = 0;
