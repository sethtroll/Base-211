...
public enum TimeUnit {
    ...
    NANOSECONDS {
        ...
        @Override
        public long toTicks(final long d) {
            return (long) (d / (TICKS_C7 / C0));
        }
    ...
    TICKS {
        @Override
        public long toNanos(final long d) {
            return x(d, TICKS_C7 / C0, MAX / (TICKS_C7 / C0));
        }

        @Override
        public long toMicros(final long d) {
            return x(d, TICKS_C7 / C1, MAX / (TICKS_C7 / C1));
        }

        @Override
        public long toMillis(final long d) {
            return x(d, TICKS_C7 / C2, MAX / (TICKS_C7 / C2));
        }
        ...
        @Override
        public long toSeconds(final long d) {
            return (long) (d / (C3 / TICKS_C7));
        }

        @Override
        public long toMinutes(final long d) {
            return (long) (d / (C4 / TICKS_C7));
        }

        @Override
        public long toHours(final long d) {
            return (long) (d / (C5 / TICKS_C7));
        }

        @Override
        public long toDays(final long d) {
            return (long) (d / (C6 / TICKS_C7));
        }
    ...
    SECONDS {
        ...
        @Override
        public long toTicks(final long d) {
            return x(d, C3 / TICKS_C7, MAX / (C3 / TICKS_C7));
        }
    ...
    MINUTES {
        ...
        @Override
        public long toTicks(final long d) {
            return x(d, C4 / TICKS_C7, MAX / (C4 / TICKS_C7));
        }
    ...
    HOURS {
        ...
        @Override
        public long toTicks(final long d) {
            return x(d, C5 / TICKS_C7, MAX / (C5 / TICKS_C7));
        }
    ...
    DAYS {
        ...
        @Override
        public long toTicks(final long d) {
            return x(d, C6 / TICKS_C7, MAX / (C6 / TICKS_C7));
        }
