...
public class PresetManagerInterface extends Interface implements SwitchPlugin {
    ...
    public void open(final Player player) {
        ...
        player.getPacketDispatcher().sendClientScript(CAPACITY_TOOLTIP_SCRIPT, "Default slots: 2<br><br>Purchasable slots:<br>Non-member slots: 3<br>Member slots: 8<br>Additional member slots: 1 per rank", getComponent("Preset cap") | (interfaceId << 46), getComponent("Capacity tooltip") | (interfaceId << 16));
    }
