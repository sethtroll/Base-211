...
public enum GourdPotion implements Drinkable {
    ELDER_MINUS(new int[]{20913, 20914, 20915, 20916}, new Boost(Skills.ATTACK, 0.1F, 4), new Boost(Skills.STRENGTH, 0.1F, 4), new Boost(Skills.DEFENCE, 0.1F, 4)),
    ELDER(new int[]{20917, 20918, 20919, 20920}, new Boost(Skills.ATTACK, 0.13F, 5), new Boost(Skills.STRENGTH, 0.13F, 5), new Boost(Skills.DEFENCE, 0.13F, 5)),
    ELDER_PLUS(new int[]{20921, 20922, 20923, 20924}, new Boost(Skills.ATTACK, 0.16F, 6), new Boost(Skills.STRENGTH, 0.16F, 6), new Boost(Skills.DEFENCE, 0.16F, 6)),
    ...
    REVITALISATION_MINUS(new int[]{20949, 20950, 20951, 20952}, Drinkable.getRestorations(0.2F, 6, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))),
    REVITALISATION(new int[]{20953, 20954, 20955, 20956}, Drinkable.getRestorations(0.25F, 8, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))),
    REVITALISATION_PLUS(new int[]{20957, 20958, 20959, 20960}, Drinkable.getRestorations(0.3F, 11, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))),
    ...
    public enum GourdType {
        ...
        GourdType(final float multiplier) {
