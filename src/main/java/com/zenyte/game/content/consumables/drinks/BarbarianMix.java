...
public enum BarbarianMix implements Drinkable {
    ...
    RESTORE_MIX(new int[]{11451, 11449}, 6, Drinkable.getRestorations(0.3F, 10, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS, Skills.AGILITY, Skills.PRAYER))),
    ...
    SUPER_RESTORE_MIX(new int[]{11495, 11493}, 6, Drinkable.getRestorations(0.25F, 8, Drinkable.getAllSkillsExcluding(Skills.HITPOINTS))),
