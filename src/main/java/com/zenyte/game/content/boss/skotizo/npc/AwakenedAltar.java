...
public class AwakenedAltar extends NPC {
    ...
    public AwakenedAltar(final int index, final Location location, final SkotizoInstance instance) {
        ...
        World.spawnObject(altar = new WorldObject(ObjectId.ALTAR_28924, 10, rotation, location));
    }
    ...
    public void awaken() {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            World.spawnObject(altar = new WorldObject(ObjectId.AWAKENED_ALTAR, 10, altar.getRotation(), location));
            spawn();
    ...
    protected void onDeath(Entity source) {
        ...
        resetAwakeningDelay();
        WorldTasksManager.schedule(() -> {
            World.spawnObject(altar = new WorldObject(ObjectId.ALTAR_28924, 10, altar.getRotation(), location));
            setAwakened(false);
            instance.refreshOverlay();
        }, 2);
    }
