...
public class Dusk extends NPC implements CombatScript {
    ...
    private void createPrison(final Location center) {
        ...
        for (final Location location : edge) {
            ...
            //invisible, used to clip
            World.spawnObject(new WorldObject(NullObjectID.NULL, 10, 3, location));
        }
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                switch(ticks++) {
                    ...
                    case 6:
                        for (final Location location : edge) {
                            World.removeObject(new WorldObject(NullObjectID.NULL, 10, 3, location));
                        }
                        stop();
                        break;
                }
