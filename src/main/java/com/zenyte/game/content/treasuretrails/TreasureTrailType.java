...
public enum TreasureTrailType {
    ...
    static {
        ...
        final Object2ObjectOpenHashMap<String, Clue> labelledClues = new Object2ObjectOpenHashMap<>();
    ...
    public static Object2ObjectMap<String, Clue> getNamedClues() {
        return namedClues;
    }

    @NotNull
    public static Clue random(@NotNull final ClueLevel level) {
