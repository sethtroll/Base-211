...
public class ClueScrollNPC extends NPCPlugin {
    ...
    public int[] getNPCs() {
        ...
        set.removeAll(new IntOpenHashSet(new int[] { NpcId.WYSON_THE_GARDENER, NpcId.DONIE, NpcId.PILES, NpcId.SQUIRE_VETERAN, NpcId.KAMFREENA, NpcId.DOMINIC_ONION, NpcId.GHOMMAL, NpcId.HAIRDRESSER, NpcId.HANS, NpcId.KEY_MASTER, NpcId.MONK_OF_ENTRANA, NpcId.MONK_OF_ENTRANA_1166, NpcId.MONK_OF_ENTRANA_1167, NpcId.MONK_OF_ENTRANA_1168, NpcId.MONK_OF_ENTRANA_1169, NpcId.TURAEL, NpcId.MAZCHNA, NpcId.VANNAKA, NpcId.CHAELDAR, NpcId.DURADEL, NullNpcID.NULL_490, NpcId.NIEVE, NpcId.CAPTAIN_TOBIAS, NpcId.SEAMAN_LORRIS, NpcId.SEAMAN_THRESNOR, 5034, NpcId.OZIACH, NpcId.ELLIS, NpcId.SBOTT, NpcId.TOOL_LEPRECHAUN, NpcId.TOOL_LEPRECHAUN_757, NpcId.TOOL_LEPRECHAUN_7757, NpcId.WIZARD_CROMPERTY, NpcId.WIZARD_CROMPERTY_8481, NpcId.BRIMSTAIL_11431, NpcId.COOK_4626, NpcId.AABLA, NpcId.SABREEN, NpcId.SURGEON_GENERAL_TAFANI, NpcId.JARAAH, 311, NpcId.OTTO_GODBLESSED, 1328, 1329, 1330, 1331, 1332, 1333, 1334, NullNpcID.NULL_2979, NpcId.MAWNIS_BUROWGAR, NpcId.WIZARD_CROMPERTY, NpcId.WIZARD_CROMPERTY, NpcId.PROSPECTOR_PERCY, NpcId.PARTY_PETE, NpcId.DOOMSAYER, NpcId.DOOMSAYER_6774 }));
