...
public enum Puzzle {
    ...
    Puzzle(final int enumId, final int puzzleBox, final ClueLevel level) {
        this.enumId = enumId;
        this.puzzleBox = puzzleBox;
        this.level = level;
    }

    public static Puzzle random(@NotNull final ClueLevel level) {
        final ObjectArrayList<Puzzle> list = new ObjectArrayList<>();
