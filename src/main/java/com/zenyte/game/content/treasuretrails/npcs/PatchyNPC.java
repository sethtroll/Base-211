...
public class PatchyNPC extends NPCPlugin implements ItemOnNPCAction {
    ...
    public Object[] getObjects() {
        return new Object[] { NpcId.PATCHY };
    }
    ...
    private enum SewableClothing {
        ...
        CAVALIER_AND_MASK(ItemId.BLACK_CAVALIER, ItemId.HIGHWAYMAN_MASK, ItemId.CAVALIER_MASK),
        BERET_MASK(ItemId.MIME_MASK, ItemId.BLACK_BERET, ItemId.BERET_MASK),
