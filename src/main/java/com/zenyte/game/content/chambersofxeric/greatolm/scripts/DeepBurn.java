...
public final class DeepBurn implements OlmCombatScript {
    ...
    public void handle(final GreatOlm olm) {
        ...
        WorldTasksManager.schedule(new WorldTask() {
            ...
            public void run() {
                ...
                final Object2IntOpenHashMap<Player> remainingInfections = new Object2IntOpenHashMap<>(infectionsMap.size());
                for (final Object2IntMap.Entry<Player> entry : infectionsMap.object2IntEntrySet()) {
    ...
    private void burn(final GreatOlm olm, final Player player, final ForceTalk chat) {
