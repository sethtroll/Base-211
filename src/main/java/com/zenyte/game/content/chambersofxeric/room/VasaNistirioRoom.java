...
public final class VasaNistirioRoom extends RaidArea {
    ...
    public void start() {
        ...
        World.spawnObject(new WorldObject(ObjectId.MAGICAL_FIRE, 10, getRotation(), fire));
    ...
    public void loadRoom() {
        ...
        for (final Location crystal : crystalLocations[index]) {
            ...
            final WorldObject obj = new WorldObject(NullObjectID.NULL_29775, 10, getRotation(), tile);
    ...
    public void resetCrystal(final int index) {
        ...
        final Location tile = getObjectLocation(crystal, 6, 6, getRotation());
        final WorldObject obj = new WorldObject(NullObjectID.NULL_29774, 10, getRotation(), tile);
