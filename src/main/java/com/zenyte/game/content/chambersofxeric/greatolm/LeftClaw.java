...
public final class LeftClaw extends GreatOlmClaw {
    ...
    protected void spawnClawlessObject() {
        ...
        final WorldObject defeatedClaw = new WorldObject(ObjectId.LARGE_ROCK_29885, 10, side == OlmRoom.LEFT ? OlmRoom.leftSideLeftClawObject.getRotation() : OlmRoom.rightSideLeftClawObject.getRotation(), room.getLocation(side == OlmRoom.LEFT ? OlmRoom.leftSideLeftClawObject : OlmRoom.rightSideLeftClawObject));
