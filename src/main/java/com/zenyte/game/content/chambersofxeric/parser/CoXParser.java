...
public class CoXParser {
    ...
    public static void printCompletions() {
    ...
    public static void printFastestRoomCompletionTimes() {
        final HashMap<String, Pair<CoXLogModel, Long>> map = new HashMap<>();
        for (CoXLogModel raid : raids) {
            ...
            for (final RaidRoomInfo room : raid.getRaidRoomInfos()) {
                ...
                if (timeInMap == null || timeInMap.getSecond() > time) {
                    map.put(room.getType(), new Pair<>(raid, (long) time));
                }
            }
        }
    ...
    public static void printFastestRaid(final String floor) {
        CoXLogModel raid = null;
        ...
        for (final CoXLogModel r : raids) {
            ...
            final RaidFloorTime time = Utils.findMatching(r.getRaidFloorTimes(), a -> a.getLevel().equalsIgnoreCase(floor));
            if (time == null) {
                continue;
            }
    ...
    public static void printDeathInfo() {
        int mostDeaths = 0;
        int totalDeaths = 0;
        final Object2IntOpenHashMap<String> roomDeaths = new Object2IntOpenHashMap<>();
        for (final CoXLogModel raid : raids) {
    ...
    public static void printRareDrops() {
        ...
        final ObjectArrayList<Pair<String, String>> list = new ObjectArrayList<>();
        for (final CoXLogModel raid : raids) {
    ...
    public static void populateRewards(@NotNull final Player player) {
        ...
        final Object2IntOpenHashMap<String> rewardMap = new Object2IntOpenHashMap<>();
        for (final CoXLogModel raid : raids) {
            for (final RaidRewardInfo entry : raid.getRaidRewardInfos()) {
                for (final RaidRewardItem reward : entry.getRewards()) {
