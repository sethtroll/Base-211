...
public final class RoomGeneration {
    ...
    public void generate() {
        ...
        final ArrayList<RaidRoom> combatRooms = new ArrayList<>(bossPattern.random(raidPattern.getCombatRooms()));
        /* A list of scavenger rooms. */
        final ArrayList<RaidRoom> scavengerRooms = new ArrayList<>(SCAVENGER_ROOMS);
        /* A list of farming/skilling rooms. */
        final ArrayList<RaidRoom> farmingRooms = new ArrayList<>(FARMING_ROOMS);
        /* A list of puzzle rooms, consisting of ice demon, creature keeper, deathly room and crab room. */
        final ArrayList<RaidRoom> puzzleRooms = new ArrayList<>(PUZZLE_ROOMS);
        /*
