...
public final class RaidHerblore {
    ...
    public enum RaidPotion {
         ...
         */
        @NotNull
        public static Item[] getPotions(@NotNull final Player player, @NotNull final Item used, @NotNull final Item usedWith) {
            ...
            for (final RaidHerblore.RaidPotion[] pots : RaidPotion.groupedValues) {
                ...
                if (potion != null) {
                    final ArrayList<Item> requiredItems = new ArrayList<>();
    ...
    public enum RaidHerb {
        ...
        RaidHerb(final int level, final int grimy, final int clean, final int xp) {
            this.level = level;
            this.grimy = grimy;
            this.clean = clean;
            this.xp = xp;
    ...
    public static final class RaidHerbCleaningAction extends Action {
         ...
         */
        public static boolean clean(@NotNull final Player player, final int id, @NotNull final OptionalInt slot) {
