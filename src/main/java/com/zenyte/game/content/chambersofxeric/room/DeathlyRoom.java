...
public final class DeathlyRoom extends RaidArea {
     ...
     */
    private static final WorldObject[] barrierLocations = new WorldObject[] { new WorldObject(ObjectId.SHIMMERING_BARRIER, 10, 0, 3270, 5360, 1), new WorldObject(ObjectId.SHIMMERING_BARRIER, 10, 1, 3309, 5368, 1), new WorldObject(ObjectId.SHIMMERING_BARRIER, 10, 2, 3355, 5360, 1) };
