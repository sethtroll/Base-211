...
public final class IceDemonRoom extends RaidArea {
    ...
    public void defreeze() {
        ...
        for (final Brazier brazier : braziers) {
            World.spawnObject(new WorldObject(ObjectId.BRAZIER_29747, brazier.getType(), brazier.getRotation(), brazier));
    ...
    public void loadRoom() {
        ...
        World.spawnObject(storm = new WorldObject(ObjectId.ICE_STORM, 10, 0, stormTile));
    ...
    public static final class Brazier extends WorldObject {
        ...
        public boolean equals(@Nullable final Object o) {
            if (o == this)
                return true;
            if (!(o instanceof Brazier other))
                return false;
            if (!other.canEqual(this))
                return false;
            if (!super.equals(o))
                return false;
            if (this.getKindling() != other.getKindling())
                return false;
            if (this.ticks != other.ticks)
                return false;
            final Object this$icefiend = this.icefiend;
            final Object other$icefiend = other.icefiend;
            if (!Objects.equals(this$icefiend, other$icefiend))
                return false;
