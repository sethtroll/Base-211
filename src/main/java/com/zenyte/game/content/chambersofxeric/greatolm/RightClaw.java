...
public final class RightClaw extends GreatOlmClaw {
    ...
    protected void spawnClawlessObject() {
        ...
        final WorldObject defeatedClaw = new WorldObject(ObjectId.CRYSTAL_STRUCTURE, 10, side == OlmRoom.LEFT ? OlmRoom.leftSideRightClawObject.getRotation() : OlmRoom.rightSideRightClawObject.getRotation(), room.getLocation(side == OlmRoom.LEFT ? OlmRoom.leftSideRightClawObject : OlmRoom.rightSideRightClawObject));
