...
public enum ScrollBookTeleport {
    ...
    ScrollBookTeleport(final TeleportScroll scroll, final int varbit) {
        this.scroll = scroll;
        this.varbit = varbit;
    }

    public static void decrementCountInBook(@NotNull final Player player, @NotNull final TeleportScroll scroll) {
