...
public class BarbarianMix implements ItemOnItemAction {
    ...
    public ItemPair[] getMatchingPairs() {
        final ArrayList<ItemOnItemAction.ItemPair> list = new ArrayList<>(Mix.VALUES.length + 6);
    ...
    private enum Mix {
        ...
        private static final Int2ObjectOpenHashMap<Mix> MAPPED_VALUES = new Int2ObjectOpenHashMap<>();
        ...
        Mix(final int basePotion, final int produce, final int level, final float experience) {
