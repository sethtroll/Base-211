...
public enum CocktailShaker {
    ...
    public static final Map<Integer, CocktailShaker> SHAKERS = new HashMap<>();
    ...
    public static boolean hasGarnish(Player player, CocktailShaker shaker, boolean special) {
        ...
        if (!special)
            if (shaker == CocktailShaker.DRUNK_DRAGON || shaker == CocktailShaker.CHOCOLATE_SATURDAY) return true;
