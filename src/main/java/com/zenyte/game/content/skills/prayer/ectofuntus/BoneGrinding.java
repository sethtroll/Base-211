...
public class BoneGrinding extends Action {
    ...
    public int processWithDelay() {
        ...
        switch (stage) {
            ...
            case COLLECTING:
                final int boneId = player.getNumericAttribute("ectofuntus grinded bone").intValue();
                final BoneGrinding.Bonemeal bonemeal = Utils.findMatching(Bonemeal.values, meal -> Utils.findMatching(meal.bones.getBones(), b -> b.getId() == boneId) != null);
                if (bonemeal == null) {
                    return -1;
                }
    ...
    enum Bonemeal {
        ...
        Bonemeal(final Bones bones, final int bonemeal) {
            this.bones = bones;
