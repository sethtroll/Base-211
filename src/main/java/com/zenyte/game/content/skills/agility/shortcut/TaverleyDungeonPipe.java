...
public class TaverleyDungeonPipe implements Shortcut {
    ...
    private static final AttachedObject PIPE_START_OBJ = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_16509, 10, 0, 2887, 9799, 0), 0, 96, -1, 2, 0, 0);

    private static final AttachedObject PIPE_END_OBJ = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_16509, 10, 2, 2890, 9799, 0), 0, 96, -1, 2, 0, 0);
