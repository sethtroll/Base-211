...
public enum StallType {
    ...
    TZHAAR_GEM_COUNTER(75, 160, 300, false, new ImmutableItem(1623, 1, 1, 23), new ImmutableItem(1621, 1, 1, 12), new ImmutableItem(1619, 1, 1, 10), new ImmutableItem(1617, 1, 1, 6), new ImmutableItem(1607, 1, 1, 23), new ImmutableItem(1605, 1, 1, 12), new ImmutableItem(1603, 1, 1, 10), new ImmutableItem(1601, 1, 1, 6), new ImmutableItem(1631, 1, 1, 3), new ImmutableItem(6573, 1, 1, 0.02)),
    TZHAAR_ORE_STALL(82, 180, 100, false, new ImmutableItem(440, 1, 1, 30), new ImmutableItem(453, 1, 1, 25), new ImmutableItem(442, 1, 1, 15), new ImmutableItem(444, 1, 1, 12), new ImmutableItem(447, 1, 1, 10), new ImmutableItem(449, 1, 1, 6), new ImmutableItem(451, 1, 1, 2));
