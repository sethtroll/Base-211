...
public final class CapeHanger implements ObjectInteraction, ItemOnObjectAction {
    ...
    private static final Map<Integer, Furniture> MAP = new HashMap<>(CAPES.length * 2);
    private static final Map<Integer, Furniture> OBJECT_MAP = new HashMap<>(CAPES.length);
    ...
    public Object[] getObjects() {
        final List<Object> list = new ArrayList<>(CAPES.length + 1);
    ...
    public void handleItemOnObjectAction(Player player, Item item, int slot, WorldObject object) {
        ...
        if (requestedFurn == null)
            return;
        final List<Item> items = new ArrayList<>(2);
