...
public enum Seedling {
    ...
    Seedling(final int seed, final int seedling, final int wateredSeedling, final int sapling) {
        this.seed = seed;
    ...
    public static Seedling getSeedling(final int id) {
        return map.get(id);
    }

    public static Seedling getSapling(final int id) {
        return saplingMap.get(id);
    }

    public static Seedling getWateredSeedling(final int id) {
        return wateredSeedlingMap.get(id);
    }

    public static Seedling getWaterableSeedling(final int id) {
        return seedlingMap.get(id);
    }

    public static boolean containsSeed(final int seed) {
        return ingredientMap.containsKey(seed);
    }

    public static boolean containsSapling(final int sapling) {
