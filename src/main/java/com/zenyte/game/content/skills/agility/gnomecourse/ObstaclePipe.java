...
public final class ObstaclePipe implements Obstacle {
    ...
    private static final AttachedObject PIPE_START_OBJ_EAST = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_23138, 10, 1, 2484, 3431, 0), 30, 126, 0, 0, -1, 2);

    private static final AttachedObject PIPE_START_OBJ_WEST = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_23138, 10, 1, 2487, 3431, 0), 30, 126, 0, 0, -1, 2);

    private static final AttachedObject PIPE_END_OBJ_EAST = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_23138, 10, 3, 2484, 3435, 0), 30, 126, 0, 0, -1, 2);

    private static final AttachedObject PIPE_END_OBJ_WEST = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_23138, 10, 3, 2487, 3435, 0), 30, 126, 0, 0, -1, 2);
