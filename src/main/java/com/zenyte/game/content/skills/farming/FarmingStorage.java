...
public class FarmingStorage {
    ...
    public FarmingStorageInterface.Option getOption(final int option) {
        final ArrayList<FarmingStorageInterface.Option> list = new ArrayList<>(6);
        ...
        final EnumMap<FarmingStorageInterface.Option, FarmingStorageInterface.Option> map = new EnumMap<>(FarmingStorageInterface.Option.class);
