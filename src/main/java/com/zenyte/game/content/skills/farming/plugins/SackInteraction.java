...
public class SackInteraction extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    public void handle() {
        bind("Fill", (player, item, container, slotId) -> {
            ...
            final SackInteraction.SackType matchingType = Utils.findMatching(SackType.values, value -> value.isOfType(sackId));
        ...
        bind("Remove-one", (player, item, container, slotId) -> {
            ...
            final int sackId = item.getId();
            final SackInteraction.SackType matchingType = Objects.requireNonNull(Utils.findMatching(SackType.values, value -> value.isOfType(sackId)));
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        ...
        final SackInteraction.SackType matchingSack = Utils.findMatching(SackType.values, value -> value.isOfType(sack.getId()));
        final SackInteraction.SackType sackType = Objects.requireNonNull(Utils.findMatching(SackType.values, value -> value.vegetableId == vegetable.getId()));
    ...
    private enum SackType {
        ...
        SackType(final int baseSackId, final int vegetableId) {
