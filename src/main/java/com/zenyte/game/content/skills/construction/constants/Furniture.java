...
public enum Furniture {
    ...
    public static final Map<Integer, Furniture> MAP = new HashMap<>(VALUES.length * 2);
    public static final Map<Integer, Furniture> DISPLAYED_MAP = new HashMap<>(VALUES.length);
