...
public class MediumSeedTable {
    ...
    static {
        table.append(ItemId.IRIT_SEED, 3, 2, 18)
                .append(ItemId.LIMPWURT_SEED, 3, 4, 24)
                .append(ItemId.WATERMELON_SEED, 2, 8, 36)
                .append(ItemId.SNAPE_GRASS_SEED, 2, 6, 16)
                ...
                .append(ItemId.TOADFLAX_SEED, 1, 1, 9)
                .append(ItemId.AVANTOE_SEED, 1, 1, 9)
                .append(ItemId.KWUARM_SEED, 1, 1, 9)
                .append(ItemId.CADANTINE_SEED, 1, 1, 9)
                .append(ItemId.LANTADYME_SEED, 1, 1, 9)
                .append(ItemId.DWARF_WEED_SEED, 1, 1, 9)
