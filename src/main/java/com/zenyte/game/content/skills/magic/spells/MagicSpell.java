...
public interface MagicSpell {
    ...
    default boolean canCast(final Player player) {
        return getSpellbook() == player.getCombatDefinitions().getSpellbook() || getSpellName().contains("Pharaoh");//for home tps on normal/ancient since they have the same name
    }
