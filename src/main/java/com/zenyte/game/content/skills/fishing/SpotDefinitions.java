...
public enum SpotDefinitions {
    ...
    RIVER_BAIT(305792, new int[]{1512, 1513, 1506, 1529, 1531, 3418, 1515, 1508, 1507, 1527, 1509, 1516, 1526, 3417}, new String[]{"Bait"}, FISHING_ROD, FishingBait.FISHING_BAIT, FishDefinitions.PIKE),
    ...
    public static SpotDefinitions get(final String query) {
