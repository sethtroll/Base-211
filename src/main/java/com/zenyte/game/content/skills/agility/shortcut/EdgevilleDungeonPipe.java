...
public class EdgevilleDungeonPipe implements Shortcut {
    ...
    private static final AttachedObject PIPE_START_OBJ = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_16511, 10, 0, 3150, 9906, 0), 0, 96, -1, 2, 0, 0);

    private static final AttachedObject PIPE_END_OBJ = new AttachedObject(new WorldObject(ObjectId.OBSTACLE_PIPE_16511, 10, 2, 3153, 9906, 0), 0, 96, -1, 2, 0, 0);
