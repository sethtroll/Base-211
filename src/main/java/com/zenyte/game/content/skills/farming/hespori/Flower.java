...
public final class Flower extends NPC implements CombatScript, Spawnable {
     ...
     */
    enum FlowerPosition {
        SOUTH_WESTERN(new Location(1243, 10083, 0)),
        NORTH_WESTERN(new Location(1243, 10091, 0)),
        NORTH_EASTERN(new Location(1251, 10091, 0)),
        SOUTH_EASTERN(new Location(1251, 10083, 0));
        static final FlowerPosition[] values = values();
        @NotNull
        private final Location tile;

        FlowerPosition(@NotNull final Location tile) {
            if (tile == null) {
