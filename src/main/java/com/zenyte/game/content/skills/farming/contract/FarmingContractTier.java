...
public enum FarmingContractTier {
    ...
    TWO(2, 7, new FarmingContractRoll(3, 5), new FarmingContractRoll(2, 3), new FarmingContractRoll(1, 1, player -> Utils.random(10) == 0)),
    ...
    FarmingContractTier(final int tierId, final int maxRolls, final FarmingContractRoll lowRolls, final FarmingContractRoll mediumRolls, final FarmingContractRoll highRolls) {
        this.tierId = tierId;
