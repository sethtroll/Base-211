...
public class FremennikIslesSailing {
     ...
     */
    public static void sail(final Player player, final SailingDestination destination) {
    ...
    public enum SailingDestination {
        ...
        SailingDestination(final int toAnimation, final int fromAnimation, final String areaName, final Location rellekka, final Location destination) {
