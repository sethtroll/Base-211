    ...
    public int attack(Entity target) {
        if (attacks >= 7) {
            if (target instanceof Player player) {
                ...
                final Dragonfire.DragonfireBuilder dragonfire = new Dragonfire.DragonfireBuilder(DragonfireType.CHROMATIC_DRAGONFIRE, 8, DragonfireProtection.getProtection(player), builder) {
                    @Override
