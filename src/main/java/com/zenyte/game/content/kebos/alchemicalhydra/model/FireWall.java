...
public enum FireWall {
    ...
    public static FireWall select(@NotNull final Position staticTargetPosition) {
    ...
    public final List<FireWallBlock> getInnerPoints(@NotNull final AlchemicalHydraInstance instance) {
        ...
        final ObjectArrayList<FireWallBlock> list = new ObjectArrayList<>(2);
        for (int i = 0; i < 2; i++) {
            final RSPolygon polygon = transformedPolygons[i];
            final ObjectOpenHashSet<Location> tileSet = new ObjectOpenHashSet<>(25);
    ...
    private enum FireBlockDirection {
        NORTH(new RSPolygon(new int[][]{{1365, 10279}, {1365, 10271}, {1369, 10271}, {1369, 10279}})),
        ...
        SOUTH_WEST(new RSPolygon(new int[][]{{1356, 10257}, {1359, 10257}, {1366, 10264}, {1366, 10265}, {1364, 10265}, {1364, 10267}, {1356, 10259}})),
        NORTH_WEST(new RSPolygon(new int[][]{{1356, 10279}, {1356, 10276}, {1363, 10269}, {1364, 10269}, {1364, 10271}, {1366, 10271}, {1358, 10279}})),
        NORTH_EAST(new RSPolygon(new int[][]{{1378, 10279}, {1376, 10279}, {1368, 10271}, {1370, 10271}, {1370, 10269}, {1371, 10269}, {1378, 10276}})),
        SOUTH_EAST(new RSPolygon(new int[][]{{1378, 10257}, {1375, 10257}, {1368, 10264}, {1368, 10265}, {1370, 10265}, {1370, 10267}, {1378, 10259}}));
        private final RSPolygon polygon;

        FireBlockDirection(final RSPolygon polygon) {
