...
public class AlchemicalDoor implements ObjectAction {
    ...
    private static final WorldObject[] graphicalDoors = { new WorldObject(NullObjectID.NULL_34555, 10, 1, new Location(1356, 10259, 0)), new WorldObject(NullObjectID.NULL_34556, 10, 3, new Location(1356, 10258, 0)) };
