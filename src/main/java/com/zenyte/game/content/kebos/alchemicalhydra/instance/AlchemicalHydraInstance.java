...
public class AlchemicalHydraInstance extends DynamicArea implements CycleProcessPlugin, LogoutPlugin, DeathPlugin, CannonRestrictionPlugin, LootBroadcastPlugin {
    ...
    public AlchemicalHydraInstance(final Player player, final AllocatedArea area) {
        ...
        this.doors = new WorldObject[] { new WorldObject(ObjectId.ALCHEMICAL_DOOR, 0, 2, getLocation(new Location(1355, 10259, 0))), new WorldObject(ObjectId.ALCHEMICAL_DOOR_34554, 0, 2, getLocation(new Location(1355, 10258, 0))) };
        this.graphicalDoors = new WorldObject[] { new WorldObject(NullObjectID.NULL_34555, 0, 1, getLocation(new Location(1356, 10259, 0))), new WorldObject(NullObjectID.NULL_34556, 0, 3, getLocation(new Location(1356, 10258, 0))) };
