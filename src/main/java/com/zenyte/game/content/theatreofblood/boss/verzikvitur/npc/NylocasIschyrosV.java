...
public class NylocasIschyrosV extends NylocasV {

    public NylocasIschyrosV(final VerzikRoom room, final Location location, final Direction direction) {
        super(room, NpcId.NYLOCAS_ISCHYROS_8381, location, direction, NylocasTypeV.MELEE);
        setAttackDistance(0);
    }
