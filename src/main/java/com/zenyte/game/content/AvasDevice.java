...
public final class AvasDevice {
    ...
    private static final ImmutableItem[] ATTRACTOR_POSSIBLE_LOOT = new ImmutableItem[]{
            new ImmutableItem(884, 1, 3, 40),
            new ImmutableItem(440, 1, 1, 16),
            new ImmutableItem(1137, 1, 1, 16),
            new ImmutableItem(1153, 1, 1, 16),
            new ImmutableItem(807, 1, 2, 16),
            new ImmutableItem(863, 1, 3, 16),
            new ImmutableItem(2351, 1, 1, 18),
            new ImmutableItem(9140, 1, 3, 20),
            new ImmutableItem(40, 1, 4, 20),
            new ImmutableItem(1141, 1, 1, 10),
            new ImmutableItem(1157, 1, 1, 10),
            new ImmutableItem(7767, 1, 1, 2),
    };

    private static final ImmutableItem[] ACCUMULATOR_POSSIBLE_LOOT = new ImmutableItem[]{
            new ImmutableItem(886, 1, 3, 30),
            new ImmutableItem(687, 1, 1, 12),
            new ImmutableItem(440, 1, 1, 12),
            new ImmutableItem(1137, 1, 1, 12),
            new ImmutableItem(1153, 1, 1, 12),
            new ImmutableItem(808, 1, 2, 12),
            new ImmutableItem(865, 1, 3, 12),
            new ImmutableItem(2353, 1, 1, 12),
            new ImmutableItem(9141, 1, 3, 12),
            new ImmutableItem(41, 1, 4, 12),
            new ImmutableItem(1141, 1, 1, 12),
            new ImmutableItem(1157, 1, 1, 12),
            new ImmutableItem(1353, 1, 1, 12),
            new ImmutableItem(1539, 1, 4, 12),
            new ImmutableItem(1119, 1, 1, 12),
            new ImmutableItem(7767, 1, 1, 2),
    };
    ...
    public static void collectMetal(final Player player) {
        ...
        if (id != 10498 && id != 10499 && id != 13337 && id != 22109 && id != 21898 && id != 50705)
            return;
