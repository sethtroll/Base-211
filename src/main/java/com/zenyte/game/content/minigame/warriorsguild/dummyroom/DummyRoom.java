...
public final class DummyRoom extends WarriorsGuildArea implements CycleProcessPlugin {
    ...
    private static final WorldObject[] DUMMIES = new WorldObject[] { new WorldObject(ObjectId.DUMMY_23958, 10, 0, new Location(2856, 3554, 0)), new WorldObject(ObjectId.DUMMY_23959, 10, 0, new Location(2858, 3554, 0)), new WorldObject(ObjectId.DUMMY_23960, 10, 1, new Location(2860, 3553, 0)), new WorldObject(ObjectId.DUMMY_23961, 10, 1, new Location(2860, 3551, 0)), new WorldObject(ObjectId.DUMMY_23962, 10, 2, new Location(2859, 3549, 0)), new WorldObject(ObjectId.DUMMY_23963, 10, 2, new Location(2857, 3549, 0)), new WorldObject(ObjectId.DUMMY_23964, 10, 3, new Location(2855, 3550, 0)) };

    private static final WorldObject[] HOLES = new WorldObject[] { new WorldObject(ObjectId.HOLE_23965, 10, 0, new Location(2856, 3554, 0)), new WorldObject(ObjectId.HOLE_24297, 10, 0, new Location(2858, 3554, 0)), new WorldObject(ObjectId.HOLE_24298, 10, 1, new Location(2860, 3553, 0)), new WorldObject(ObjectId.HOLE_24299, 10, 1, new Location(2860, 3551, 0)), new WorldObject(ObjectId.HOLE_24300, 10, 2, new Location(2859, 3549, 0)), new WorldObject(ObjectId.HOLE_24301, 10, 2, new Location(2857, 3549, 0)), new WorldObject(ObjectId.HOLE_24302, 10, 3, new Location(2855, 3550, 0)) };

    private static final WorldObject EXTRA_DUMMY = new WorldObject(ObjectId.DUMMY_23961, 10, 3, new Location(2855, 3552, 0));

    private static final WorldObject EXTRA_HOLE = new WorldObject(ObjectId.HOLE_24299, 10, 3, new Location(2855, 3552, 0));
