...
public class BlastFurnaceArea extends Area implements CannonRestrictionPlugin, LayableTrapRestrictionPlugin, CycleProcessPlugin {
    ...
    public static final WorldObject BAR_DISPENSER = new WorldObject(NullObjectID.NULL_9092, 10, 0, new Location(1940, 4963, 0));

    /* Minigame data */
    public static final boolean FURNACE_ACTIVE = true;

    /* Objects */
    private static final WorldObject CONVEYER_MAIN = new WorldObject(ObjectId.CONVEYOR_BELT, 10, 0, new Location(1943, 4967, 0));

    private static final WorldObject CONVEYER_TWO = new WorldObject(ObjectId.CONVEYOR_BELT_9101, 10, 0, new Location(1943, 4966, 0));

    private static final WorldObject CONVEYER_THREE = new WorldObject(ObjectId.CONVEYOR_BELT_9101, 10, 0, new Location(1943, 4965, 0));

    private static final WorldObject COGS_NORTH = new WorldObject(ObjectId.COGS, 10, 0, new Location(1945, 4967, 0));

    private static final WorldObject COGS_SOUTH = new WorldObject(ObjectId.COGS_9108, 10, 0, new Location(1945, 4965, 0));

    private static final WorldObject DRIVE_BELT_NORTH = new WorldObject(ObjectId.DRIVE_BELT, 10, 0, new Location(1944, 4967, 0));

    private static final WorldObject DRIVE_BELT_SOUTH = new WorldObject(ObjectId.DRIVE_BELT_9107, 10, 0, new Location(1944, 4965, 0));

    private static final WorldObject GEAR_BOX = new WorldObject(ObjectId.GEAR_BOX, 10, 0, new Location(1945, 4966, 0));

    /* Object spawns / removals */
    private static final WorldObject REMOVE_PEDALS = new WorldObject(ObjectId.PEDALS, 10, 1, new Location(1947, 4966, 0));

    private static final WorldObject REMOVE_PUMP = new WorldObject(ObjectId.PUMP, 10, 1, new Location(1950, 4961, 0));

    private static final WorldObject FULL_STOVE = new WorldObject(ObjectId.STOVE_9087, 10, 0, new Location(1948, 4963, 0));
