...
public class Inferno extends DynamicArea implements CycleProcessPlugin, LogoutPlugin, DeathPlugin, CannonRestrictionPlugin, TeleportPlugin, DropPlugin {
    ...
    public Inferno(final Player player, final AllocatedArea area, final boolean practiceMode) {
        ...
        wallPatches = new WorldObject[] { new WorldObject(NullObjectID.NULL_30339, 10, 3, getLocation(2275, 5364, 0)), new WorldObject(NullObjectID.NULL_30340, 10, 1, getLocation(2267, 5364, 0)), new WorldObject(NullObjectID.NULL_30341, 10, 3, getLocation(2275, 5366, 0)), new WorldObject(NullObjectID.NULL_30342, 10, 1, getLocation(2267, 5366, 0)) };
        fallingRocks = new WorldObject[] { new WorldObject(ObjectId.FALLING_ROCK, 10, 3, getLocation(2273, 5364, 0)), new WorldObject(ObjectId.FALLING_ROCK_30344, 10, 3, getLocation(2268, 5364, 0)) };
    ...
    public void constructed() {
        ...
        for (final Location tile : dragBlockTiles) {
            World.spawnObject(new WorldObject(NullObjectID.NULL, 10, 0, tile));
        }
        if (!resuming) {
