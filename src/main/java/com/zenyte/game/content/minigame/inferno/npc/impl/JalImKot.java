...
public class JalImKot extends InfernoNPC {
    ...
    private Location getBurrowLocation() {
        ...
        final Optional<Location> optionalLocation = Utils.findEmptySquare(player.getLocation(), player.getSize() + getSize(), getSize(), Optional.of(l -> CombatUtilities.isWithinMeleeDistance(l, getSize(), player)));
