...
public class WintertodtPrisonArea extends WintertodtCampArea implements CannonRestrictionPlugin, LayableTrapRestrictionPlugin, DropPlugin, RandomEventRestrictionPlugin, LogoutPlugin, LoginPlugin, CycleProcessPlugin {
    ...
    private static void startAOEAttack(final Player player) {
        ...
        WorldTasksManager.schedule(() -> {
            ...
            World.spawnTemporaryObject(new WorldObject(NullObjectID.NULL_29324, 10, 0, middleLocation.getX(), middleLocation.getY(), 0), 7);
            World.sendGraphics(new Graphics(502), middleLocation);
            for (Location location : cornerLocations) {
                World.spawnTemporaryObject(new WorldObject(NullObjectID.NULL_29325, 10, 0, location.getX(), location.getY(), 0), 7);
    ...
    public void enter(Player player) {
        ...
        // unhide overlay components
        player.getPacketDispatcher().sendClientScript(1433);
    ...
    public void leave(Player player, boolean logout) {
        ...
        player.getPacketDispatcher().sendClientScript(1432);
        Wintertodt.resetPlayer(player);
    }
