...
public class PuroPuroArea extends Area implements CycleProcessPlugin, LoginPlugin {
    ...
    private static final ObjectArrayList<MagicalWheatSpawn> wheatSpawns = new ObjectArrayList<>(Arrays.asList(// perpendicular
    new MagicalWheatSpawn(new Location(2584, 4330), new Location(2584, 4329), true), new MagicalWheatSpawn(new Location(2594, 4330), new Location(2594, 4329), true), new MagicalWheatSpawn(new Location(2601, 4333), new Location(2601, 4332), true), new MagicalWheatSpawn(new Location(2582, 4333), new Location(2582, 4332), true), new MagicalWheatSpawn(new Location(2584, 4336), new Location(2584, 4335), true), new MagicalWheatSpawn(new Location(2576, 4339), new Location(2576, 4338), true), new MagicalWheatSpawn(new Location(2598, 4336), new Location(2598, 4335), true), new MagicalWheatSpawn(new Location(2604, 4339), new Location(2604, 4338), true), new MagicalWheatSpawn(new Location(2585, 4310), new Location(2585, 4309), true), new MagicalWheatSpawn(new Location(2598, 4310), new Location(2598, 4309), true), new MagicalWheatSpawn(new Location(2587, 4307), new Location(2587, 4306), true), new MagicalWheatSpawn(new Location(2583, 4304), new Location(2583, 4303), true), new MagicalWheatSpawn(new Location(2602, 4307), new Location(2602, 4306), true), new MagicalWheatSpawn(new Location(2603, 4304), new Location(2603, 4303), true), // regular
    ...
    private static class PuroPuroImplingSpawn {
        ...
        public boolean equals(@Nullable final Object o) {
            if (o == this)
                return true;
            if (!(o instanceof PuroPuroImplingSpawn other))
                return false;
    ...
    public static class MagicalWheatSpawn {
        ...
        public void despawn() {
            ...
            WorldTasksManager.schedule(() -> {
                ...
                World.spawnObject(new WorldObject(NullObjectID.NULL_25000, 22, perpendicular ? 2 : isVertical() ? 2 : 1, getFirst()));
                World.spawnObject(new WorldObject(NullObjectID.NULL_25000, 22, perpendicular ? 2 : isVertical() ? 2 : 1, getSecond()));
                spawnCooldown = false;
        ...
        public boolean equals(@Nullable final Object o) {
            if (o == this)
                return true;
            if (!(o instanceof MagicalWheatSpawn other))
                return false;
            if (!other.canEqual(this))
                return false;
            if (this.isPerpendicular() != other.isPerpendicular())
                return false;
            if (this.isVisible() != other.isVisible())
                return false;
            if (this.isSpawnCooldown() != other.isSpawnCooldown())
                return false;
