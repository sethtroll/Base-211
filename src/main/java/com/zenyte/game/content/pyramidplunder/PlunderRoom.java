...
public enum PlunderRoom {
    FIRST_ROOM(1, 21, 60, 40, 20, 40, 10, new ImmutableLocation(1927, 4477, 0), new RSPolygon(new int[][]{{1920, 4480}, {1920, 4463}, {1934, 4463}, {1934, 4480}})),
    SECOND_ROOM(2, 31, 90, 60, 30, 60, 10, new ImmutableLocation(1954, 4477, 0), new RSPolygon(new int[][]{{1947, 4480}, {1947, 4463}, {1961, 4463}, {1961, 4480}})),
    THIRD_ROOM(3, 41, 150, 100, 50, 100, 10, new ImmutableLocation(1977, 4471, 0), new RSPolygon(new int[][]{{1968, 4473}, {1968, 4453}, {1982, 4453}, {1982, 4473}})),
    FOURTH_ROOM(4, 51, 215, 140, 70, 140, 10, new ImmutableLocation(1927, 4453, 0), new RSPolygon(new int[][]{{1924, 4460}, {1924, 4448}, {1943, 4448}, {1943, 4460}})),
    FIFTH_ROOM(5, 61, 300, 200, 100, 200, 10, new ImmutableLocation(1965, 4444, 0), new RSPolygon(new int[][]{{1951, 4456}, {1951, 4442}, {1967, 4442}, {1967, 4456}})),
    SIXTH_ROOM(6, 71, 450, 300, 150, 300, 10, new ImmutableLocation(1927, 4424, 0), new RSPolygon(new int[][]{{1921, 4441}, {1921, 4422}, {1933, 4422}, {1933, 4441}})),
    SEVENTH_ROOM(7, 81, 675, 450, 225, 450, 10, new ImmutableLocation(1943, 4421, 0), new RSPolygon(new int[][]{{1940, 4434}, {1940, 4420}, {1956, 4420}, {1956, 4434}})),
    EIGHT_ROOM(8, 91, 825, 550, 275, 0, 10, new ImmutableLocation(1974, 4420, 0), new RSPolygon(new int[][]{{1967, 4438}, {1967, 4419}, {1980, 4419}, {1980, 4438}}));
    ...
    PlunderRoom(final int roomId, final int level, final double urnExp, final double chestExp, final double sarcophagusExp, final double doorExp, final double trapExp, final ImmutableLocation start, final RSPolygon polygon) {
        this.roomId = roomId;
        this.level = level;
        this.urnExp = urnExp;
