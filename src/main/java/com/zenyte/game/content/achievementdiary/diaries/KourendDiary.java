...
public enum KourendDiary implements Diary {
    ...
    CATCH_ANGLERFISH(ELITE, 1 | 2, "Catch an Anglerfish and cook it whilst in Great Kourend.") {
        @Override
    ...
    CREATE_BATTLESTAFF(ELITE, false, 1 | 2, p -> p.inArea(FarmingGuildArea.class), "Create your own Battlestaff from scratch within the", "Farming Guild.") {
        @Override
        public boolean flagging() {
            return true;
        }
