...
public enum FremennikDiary implements Diary {
    ...
    KILL_DAGANNOTH_KINGS(ELITE, false, 1 | 2 | 4, NO_PREDICATE, "Kill each of the Dagannoth Kings.") {
        @Override
        public boolean flagging() {
            return true;
        }
    ...
    KILL_GODWARS_GENERALS(ELITE, false, 1 | 2 | 4 | 8, NO_PREDICATE, "Kill each of the Godwars generals.") {
        @Override
        public boolean flagging() {
            return true;
        }
