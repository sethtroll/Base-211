...
public enum FaladorDiary implements Diary {
    ...
    CHOP_BURN_WILLOW_LOGS(MEDIUM, false, 1 | 2, p -> p.inArea("Taverley"), "Chop and burn some Willow logs in Taverley") {
        @Override
    ...
    MIX_SARADOMIN_BREW(ELITE, p -> p.inArea("Falador East Bank"), "Mix a Saradomin brew in Falador east bank.");
