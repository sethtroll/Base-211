...
public class ItemOnCastleWarsCatapult implements ItemOnObjectAction {
    ...
    public static final WorldObject SARADOMIN_CATAPULT = new WorldObject(ObjectId.CATAPULT_4382, 11, 3, new Location(2413, 3088, 0));

    public static final WorldObject BROKEN_SARADOMIN_CATAPULT = new WorldObject(ObjectId.CATAPULT_4385, 10, 3, SARADOMIN_CATAPULT);

    public static final WorldObject ZAMORAK_CATAPULT = new WorldObject(ObjectId.CATAPULT_4381, 11, 1, new Location(2484, 3117, 0));

    public static final WorldObject BROKEN_ZAMORAK_CATAPULT = new WorldObject(ObjectId.CATAPULT_4386, 10, 1, ZAMORAK_CATAPULT);
