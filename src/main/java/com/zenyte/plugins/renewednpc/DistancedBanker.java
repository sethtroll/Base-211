...
public class DistancedBanker extends NPCPlugin implements ItemOnNPCAction {
    ...
    @Override
    public int[] getNPCs() {
        return new int[] { NpcId.BANKER_2117, NpcId.BANKER_2118, NpcId.MAGNUS_GRAM, 10029, 10030 };
    }
    ...
    public Object[] getObjects() {
        return new Object[] { NpcId.BANKER_2117, NpcId.BANKER_2118, NpcId.MAGNUS_GRAM, 10029, 10030 };
    }
}
