    ...
    public void handle() {
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                npc(5, "Certainly. If you own a rune pouch and pick up runes that you have stored in it, I can make those runes be automatically added to your rune pouch, providing your have space " + "for" + " them all! Or you can let them go into");
                npc("your inventory like normal.");
                npc("How do you want to handle picking up runes?");
                options(TITLE, new DialogueOption("Automatically send to rune pouch.", () -> {
                    setKey(22);
