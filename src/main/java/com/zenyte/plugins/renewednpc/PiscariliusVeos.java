...
public class PiscariliusVeos extends NPCPlugin {
    ...
    public void handle() {
        ...
        bind("Port Sarim", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            @Override
            public void buildDialogue() {
    ...
    public int[] getNPCs() {
        return new int[]{
                NpcId.VEOS, NpcId.VEOS_8484, NpcId.VEOS_10723, NpcId.VEOS_10724, NpcId.VEOS_10727, NpcId.VEOS_10949
        };
    }
}
