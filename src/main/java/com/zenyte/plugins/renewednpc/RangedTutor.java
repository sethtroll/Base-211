        ...
        bind("Talk-to", (player, npc) -> player.getDialogueManager().start(new Dialogue(player, npc) {
            ...
            public void buildDialogue() {
                ...
                if (player.getNumericAttribute("equip ammunition picked up").intValue() == 0) {
                    ...
                    npc("Of course, from here on out, all ammunition that you pick up, granted you have at least one of the " + "same type ammunition equipped and can carry the entire stack, will be equipped automatically.");
                } else {
