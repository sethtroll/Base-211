...
public class Torfinn extends NPCPlugin {
    ...
    public void handle() {
        ...
        bind("Ungael", (player, npc) -> sail(player, true));
    ...
    @Override
    public int[] getNPCs() {
        return new int[] { NpcId.TORFINN, NpcId.TORFINN_10403, NpcId.TORFINN_10404, NpcId.TORFINN_10405, NpcId.TORFINN_10406, 7504 };
    }
}
