...
public class CastleWarsFlagObject implements ObjectAction {
    ...
    public static final WorldObject saradominFlag = new WorldObject(ObjectId.SARADOMIN_STANDARD_4902, 11, 1, new Location(2429, 3074, 3));

    public static final WorldObject saradominFlagStand = new WorldObject(ObjectId.STANDARD_STAND, 11, 1, new Location(2429, 3074, 3));

    public static final int ZAMORAK_FLAG_GROUND = 4901;

    public static final WorldObject zamorakFlag = new WorldObject(ObjectId.ZAMORAK_STANDARD_4903, 11, 3, new Location(2370, 3133, 3));

    public static final WorldObject zamorakFlagStand = new WorldObject(ObjectId.STANDARD_STAND_4378, 11, 3, new Location(2370, 3133, 3));
