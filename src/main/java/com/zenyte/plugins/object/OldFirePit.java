...
public class OldFirePit implements ObjectAction {
    ...
    public enum FirePit {
        ...
        FirePit(final int objectId, final FireType type, final Consumer<Player> onBuild) {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        final OldFirePit.FirePit pit = Utils.findMatching(FirePit.pits, p -> p.objectId == object.getId());
        assert pit != null;
