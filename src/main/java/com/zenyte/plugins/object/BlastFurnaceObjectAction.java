...
public class BlastFurnaceObjectAction implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (object.getId() == NullObjectID.NULL_29330) {
        ...
        // bar dispenser
        if (object.getId() == NullObjectID.NULL_9092) {
    ...
    public Object[] getObjects() {
        return new Object[] { ObjectId.TEMPERATURE_GAUGE, ObjectId.PUMP, ObjectId.STOVE, ObjectId.COKE, ObjectId.PEDALS, ObjectId.MELTING_POT, NullObjectID.NULL_9092, ObjectId.BAR_DISPENSER, ObjectId.BAR_DISPENSER_9094, ObjectId.BAR_DISPENSER_9095, ObjectId.BAR_DISPENSER_9096, ObjectId.CONVEYOR_BELT, NullObjectID.NULL_29330 };
    }
}
