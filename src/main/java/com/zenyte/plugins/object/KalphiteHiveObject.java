...
public class KalphiteHiveObject implements ObjectAction {
    ...
    public void handleObjectAction(Player player, WorldObject object, String name, int optionId, String option) {
        if (object.getId() == NullObjectID.NULL_3827) {
    ...
    public Object[] getObjects() {
        return new Object[] { NullObjectID.NULL_3827, ObjectId.TUNNEL_ENTRANCE, ObjectId.ROPE_3829, ObjectId.ROPE_3832, 23609, ObjectId.CREVICE_26712, ObjectId.CAVE_30180 };
    }
}
