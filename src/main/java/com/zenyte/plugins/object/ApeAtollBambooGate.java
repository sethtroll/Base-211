...
public class ApeAtollBambooGate implements ObjectAction {
    ...
    private static final WorldObject left = new WorldObject(ObjectId.BAMBOO_GATE, 10, 0, 2719, 2766, 0);

    private static final WorldObject right = new WorldObject(ObjectId.BAMBOO_GATE_4788, 10, 2, 2721, 2766, 0);
