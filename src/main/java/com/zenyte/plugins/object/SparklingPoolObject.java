...
public class SparklingPoolObject implements ObjectAction {
    ...
    private static final AttachedObject UPPER = new AttachedObject(new WorldObject(ObjectId.SPARKLING_POOL, 10, 0, 2541, 4719, 0), 0, 120, -2, 2, -2, 2);

    private static final AttachedObject LOWER = new AttachedObject(new WorldObject(ObjectId.SPARKLING_POOL_2879, 10, 0, 2508, 4686, 0), 0, 120, -2, 2, -2, 2);
