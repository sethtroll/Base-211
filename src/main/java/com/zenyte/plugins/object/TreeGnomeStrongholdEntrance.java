...
public class TreeGnomeStrongholdEntrance implements ObjectAction {
    ...
    private static final WorldObject LEFT_GATE = new WorldObject(NullObjectID.NULL_191, 10, 2, 2459, 3383, 0);

    private static final WorldObject RIGHT_GATE = new WorldObject(NullObjectID.NULL_192, 10, 0, 2462, 3383, 0);
