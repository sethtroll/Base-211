...
public class LightSourceItem extends ItemPlugin implements ItemOnItemAction {
    ...
    public enum LightSource {
        ...
        public static LightSource getSource(final Item item) {
            if (item == null) {
                return null;
            }
        ...
        public static LightSource[] getLitLightSources(final Player player, final int flag) {
            final ArrayList<LightSourceItem.LightSource> list = new ArrayList<>();
        ...
        public static int getLitSourcesCount(final Player player) {
            int count = 0;
            final Inventory inventory = player.getInventory();
            final Equipment equipment = player.getEquipment();
            for (final Int2ObjectMap.Entry<LightSourceItem.LightSource> entry : LIT_MAPPED_SOURCES.int2ObjectEntrySet()) {
        ...
        public static int getBrightness(final Player player) {
        ...
        public static void extinguish(final Player player, int amount, final LightSource... sources) {
        ...
        LightSource(final int unlitId, final int litId, final int level, final int brightness, final int mask) {
    ...
    public ItemPair[] getMatchingPairs() {
        final ArrayList<ItemOnItemAction.ItemPair> list = new ArrayList<>();
