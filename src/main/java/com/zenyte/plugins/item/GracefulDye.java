...
public class GracefulDye extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    private static boolean isWhiteUnlocked(@NotNull final Player player) {
    ...
    private static void recolour(@NotNull final Player player, @NotNull final Item from, @NotNull final Item to, final int fromSlot, final int toSlot, @NotNull final RecolourDye dye) {
        ...
        final GracefulDye.RecolouredGraceful recolourConst = Utils.findMatching(RecolouredGraceful.values, value -> value.dye == dye && ItemDefinitions.getOrThrow(value.recolouredPiece).getSlot() == gracefulEquipSlot);
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        ...
        final ObjectArrayList<GracefulDye.RecolourDye> colourList = new ObjectArrayList<>();
    ...
    public ItemPair[] getMatchingPairs() {
        final ObjectArrayList<ItemOnItemAction.ItemPair> pairs = new ObjectArrayList<>();
    ...
    private enum RegularGraceful {
        ...
        RegularGraceful(final int itemId) {
            this.itemId = itemId;
        }
    }
    ...
    private enum RecolouredGraceful {
        ...
        RecolouredGraceful(final RecolourDye dye, final int recolouredPiece) {
            this.dye = dye;
    ...
    public static final class GracefulCleaning implements PairedItemOnItemPlugin {
        ...
        public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
            ...
            final GracefulDye.RegularGraceful regularPiece = Utils.findMatching(RegularGraceful.values, p -> ItemDefinitions.getOrThrow(p.itemId).getSlot() == slot);
