...
public class RingOfReturningItem extends ItemPlugin {
    ...
    private enum RingOfReturning {
        ...
        @NotNull
        private static RingOfReturning get(@NotNull final Item item) {
    ...
    private static final class RingTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>Your ring of returning crumbles to dust.</col>" : charges == 2 ? "<col=7F00FF>Your ring of returning has one use left.</col>" : "<col=7F00FF>Your ring of returning has " + Utils.format(charges - 1) + " uses left.</col>";
