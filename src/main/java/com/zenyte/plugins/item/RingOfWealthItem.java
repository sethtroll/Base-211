...
public class RingOfWealthItem extends ItemPlugin implements ItemOnItemAction {
    ...
    public static boolean isRingOfWealth(final Item item) {
    ...
    private enum RingOfWealth {
        ...
        @NotNull
        private static RingOfWealth get(@NotNull final Item item) {
        ...
        RingOfWealth(final Item item, final Item result, final int charges, final boolean imbued) {
            this.item = item;
            this.result = result;
            this.charges = charges;
            this.imbued = imbued;
    ...
    private static final class RingTeleport implements Teleport {
        ...
        public void onArrival(final Player player) {
            ...
            final String message = charges == 1 ? "<col=7F00FF>You use your amulet's last charge." : charges == 2 ? "<col=7F00FF>Your ring of wealth has one charge left..</col>" : "<col=7F00FF>Your ring of wealth has " + Utils.format(charges - 1) + " charges left.</col>";
