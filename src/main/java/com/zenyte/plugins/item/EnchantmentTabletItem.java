...
public class EnchantmentTabletItem extends ItemPlugin implements PairedItemOnItemPlugin {
    ...
    private enum EnchantmentTab {
        ...
        private static EnchantmentTab get(final int id) {
            return Utils.findMatching(values, value -> value.tabId == id);
        }

        EnchantmentTab(final int tabId, final JewelleryEnchantmentType type, final String typeString) {
            this.tabId = tabId;
            this.type = type;
    ...
    public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
        ...
        final JewelleryEnchantment.JewelleryEnchantmentItem data = Utils.findMatching(JewelleryEnchantment.JewelleryEnchantmentItem.values, item -> item.getBase().getId() == jewellery.getId());
        assert data != null;
