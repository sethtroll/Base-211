...
public enum SeaTrident implements Trident {
    ...
    SEA_TRIDENT_ENHANCED(ItemId.UNCHARGED_TRIDENT_E, ItemId.TRIDENT_OF_THE_SEAS_E, 20000);
    ...
    SeaTrident(final int unchargedId, final int chargedId, final int maxCharges) {
