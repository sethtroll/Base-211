...
public enum SwampTrident implements Trident {
    ...
    SWAMP_TRIDENT_E(ItemId.UNCHARGED_TRIDENT_E, ItemId.UNCHARGED_TOXIC_TRIDENT_E, ItemId.TRIDENT_OF_THE_SWAMP_E, 20000);
    ...
    SwampTrident(final int baseId, final int unchargedId, final int chargedId, final int maxCharges) {
        this.baseId = baseId;
