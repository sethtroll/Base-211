...
public class SherlocksNotes extends ItemPlugin implements PairedItemOnItemPlugin {
    private static final int SHERLOCK_NOTES = 30210;
    ...
    public void handleItemOnItemAction(Player player, Item from, Item to, int fromSlot, int toSlot) {
        final Item paper = from.getId() == SHERLOCK_NOTES ? from : to;
    ...
    public ItemPair[] getMatchingPairs() {
        ...
        for (final int clue : ClueItem.getCluesArray()) {
            list.add(ItemPair.of(SHERLOCK_NOTES, clue));
        }
