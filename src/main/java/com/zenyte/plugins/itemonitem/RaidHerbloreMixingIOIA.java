...
public final class RaidHerbloreMixingIOIA implements PairedItemOnItemPlugin {
    ...
    public void handleItemOnItemAction(final Player player, final Item from, final Item to, final int fromSlot, final int toSlot) {
        final RaidHerblore.RaidHerb fromHerb = Utils.findMatching(RaidHerblore.RaidHerb.values, value -> value.getClean() == from.getId());
        final RaidHerblore.RaidHerb toHerb = Utils.findMatching(RaidHerblore.RaidHerb.values, value -> value.getClean() == to.getId());
