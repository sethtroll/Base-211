...
public class DarkBowPaint implements ItemOnItemAction {
    ...
    public enum BowPaint {
        ...
        public static final Int2ObjectOpenHashMap<BowPaint> MAPPED_VALUES = new Int2ObjectOpenHashMap<>(VALUES.length);
        ...
        BowPaint(final int paintId, final int recolouredBowId) {
