...
public class AbyssalWhipMix implements ItemOnItemAction {
    ...
    public enum WhipMix {
        ...
        public static final Int2ObjectOpenHashMap<WhipMix> MAPPED_VALUES = new Int2ObjectOpenHashMap<>(VALUES.length);
        ...
        WhipMix(final int mixId, final int recolouredWhipId, final String substanceName) {
            this.mixId = mixId;
