...
public class CatacombsProcessor extends DropProcessor {
    ...
    @Override
    public int[] ids() {
        final IntOpenHashSet set = new IntOpenHashSet(new int[]{7268, 7276, 7256, 7247, 7251, 7248, 7255, 7252, 7272, 7273, 7246, 7277, 7279, 7244, 7242, 7243, 7241, 7270, 7258, 7245, 7278, 7250, 7253, 7254, 7249, 7275, 7274, 7269, 7271, 7265, 7259, 7257, 7260, 7261, 7262});
