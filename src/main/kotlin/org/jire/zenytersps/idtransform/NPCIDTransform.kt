...
import org.jire.zenytersps.idtransform.IDTransform.matches
...
/*            && crawlAnimation == other.crawlAnimation
            ...
            && headIconArchiveIds.contentEquals(other.headIconArchiveIds)
            && headIconSpriteIndex.contentEquals(other.headIconSpriteIndex)
